...
刷完了课，作业完成了 cuda 相关的基础要求（[GPU-Programming/CIS565 at main · jsjtxietian/GPU-Programming](https://github.com/jsjtxietian/GPU-Programming/tree/main/CIS565)），vulkan 的略过了。
...
Performance Lab 手把手教了**Nsight Compute**怎么用（数据真的详细），以及优化 Transpose 和 Reduction
...
* 2023 年的 vulkan 入门介绍，webgpu 不感兴趣没看
* 各个作业的 recitation，很 practical
