...
**Scheduling Threads**：What actually happens when you launch a kernel say with 100 blocks each with 64 threads?
...
* Memory Coalescing ( **Device Level** )：
  ...
  * L1 cache is 128-bytes aligned, Multiples of 128B are read; L2 cache is 32-bytes aligned,  Multiples of 32B are read
  * For Modern GPUs, L1 is reserved for Local Memory; **Global Memory -> L2 caching**; **L1 cache are also accessed by 32 Bytes**, 1 Sector = 32 Bytes, 1 Cache Line = 4 Sectors = 128 Bytes (for L1, L2)
...
* 2023年的ray tracing入门介绍，比较基础，展示为主
* 各个作业的recitation，很practical
* 三星的embedded graphics lecture：[CIS 5650 - Guest Lecture - Gabe Dagani_](https://www.bilibili.com/video/BV1mQ4y177tj?spm_id_from=333.788.videopod.episodes&vd_source=2ed13612df005a05ffd15b1da3dab557&p=19)
